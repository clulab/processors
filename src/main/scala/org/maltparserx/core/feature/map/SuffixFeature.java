...
import org.maltparserx.core.feature.value.FunctionValue;
...
//		setSymbolTable(tableHandler.addSymbolTable("SUFFIX_"+suffixLength+"_"+parentFeature.getSymbolTable().getName(), parentFeature.getSymbolTable()));
	...
	public Class<?>[] getParameterTypes() {
		Class<?>[] paramTypes = { org.maltparserx.core.syntaxgraph.feature.InputColumnFeature.class, java.lang.Integer.class };
		return paramTypes; 
	}
