+ **10.0.0** - Complete reorganization. New syntactic parser in BalaurProcessor using the algorithm of Amini et al. (2023). Removed CoreNLP and GloVe. Everything is Apache now.
