 ...
 */
object RnnLMTrain2 {
  val logger:Logger = LoggerFactory.getLogger(classOf[RnnLMTrain2])
  ...
  def main(args: Array[String]): Unit = {
    ...
    val learnedWordEmbeddingSize = config.getArgInt("rnnlm.train.learnedWordEmbeddingSize", Some(32))
