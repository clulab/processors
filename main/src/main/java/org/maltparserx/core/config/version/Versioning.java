				...
				if (lines[i].startsWith(container+"\tguide\tfeatures")) {
					...
					if (lines[i].startsWith(container+"\tnivre\tpost_processing")) {
						...
						if (lines[i].endsWith("NivreStandard")) {
							outString.append("class org.maltparserx.parser.algorithm.nivre.NivreArcStandardFactory");
						} else if (lines[i].endsWith("NivreEager")) {
							outString.append("class org.maltparserx.parser.algorithm.nivre.NivreArcEagerFactory");
						} else if (lines[i].endsWith("CovingtonNonProjective")) {
							outString.append("class org.maltparserx.parser.algorithm.covington.CovingtonNonProjFactory");
						} else if (lines[i].endsWith("CovingtonProjective")) {
							outString.append("class org.maltparserx.parser.algorithm.covington.CovingtonProjFactory");
						}
						outString.append('\n');
					}
				} else {
