...
import org.clulab.processors.clu.CluProcessorWithStanford
...
/**
  ...
  * Date: 8/2/17
  */
class TestStanfordEnhancedDependencies extends FlatSpec with Matchers {
  val proc = new CluProcessorWithStanford()

  "CluProcessorWithStanford" should "parse some basic sentences correctly" in {
