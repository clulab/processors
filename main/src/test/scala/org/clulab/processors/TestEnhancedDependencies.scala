...
class TestEnhancedDependencies extends FlatSpec with Matchers {
  ...
  it should "collapse prepositions" in {
    ...
    doc.sentences.head.universalEnhancedDependencies.get.hasEdge(1, 5, "prep_to") should be(true)
    doc.sentences.head.universalEnhancedDependencies.get.hasEdge(1, 4, "prep") should be(false)
    doc.sentences.head.universalEnhancedDependencies.get.hasEdge(4, 5, "pobj") should be(false)
  }
  ...
  it should "propagate subjects and objects in conjoined verbs" in {
    ...
    doc.sentences.head.universalEnhancedDependencies.get.hasEdge(2, 7, "prep_by") should be(true)
    doc.sentences.head.universalEnhancedDependencies.get.hasEdge(4, 7, "prep_by") should be(true)
